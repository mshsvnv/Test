...
func (r *RacketRepository) Delete(ctx context.Context, id int) error {
...
func (r *RacketRepository) GetAllRackets(ctx context.Context, req *dto.ListRacketsReq) ([]*model.Racket, error) {
